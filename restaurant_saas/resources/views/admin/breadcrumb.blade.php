    ...
    <div class="d-flex justify-content-between align-items-center">
        <ol class="breadcrumb mb-0">
            ...
            @if (request()->is('admin/vendor*'))
                <li class="breadcrumb-item"><a href="{{ URL::to('admin/vendor') }}">{{ trans('labels.vendor') }}</a></li>
            @endif
            ...
            @if (request()->is('admin/plan*'))
                <li class="breadcrumb-item"><a href="{{ URL::to('admin/plan') }}">{{ trans('labels.Subscription Plan') }}</a></li>
            @endif
