<header class="page-topbar">
    <div class="navbar-header">
        ...
        <div class="px-3 d-flex align-items-center">
            ...
            <a href="{{ URL::to('/admin/admin_back') }}" class="btn btn-primary btn-sm mx-1"><i class="fa-solid fa-backward"></i></a>
            @endif
            @if (Auth::user()->type == 5)
            <a href="{{ URL::to('/' . Auth::user()->slug) }}" class="btn btn-outline-secondary btn-sm mx-1" target="_blank"><i class="fa-solid fa-link"></i>
            </a>
            @endif
