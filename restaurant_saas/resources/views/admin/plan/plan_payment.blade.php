        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" action="{{ URL::to('admin/plan/buyplan') }}" method="POST">
                <div class="modal-body">
                    ...
                    <p> {{ trans('labels.bank_transfer') }} : <span class="bank_transfer"></span></p>
...
<script src="{{ url(env('ASSETSPATHURL') . 'admin-assets/assets/js/custom/plan_payment.js') }}"></script>
@endsection