...
class PosController extends Controller
{
    ...
    public function placeorder(Request $request)
    {
        ...
        try {
            $order = new Order;
            $order->order_number = substr(str_shuffle(str_repeat("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", 10)), 0, 10);
    ...
    {
        $getorders = Order::with('user_info')->where('order_from','=','pos')->select('order.*')->orderByDesc('id')->get();
        return view('admin.pos.orders',compact('getorders'));
    }
}
