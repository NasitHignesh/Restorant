...
class UserController extends Controller
{
    public function index(){
        $getusers = User::where('type', '=' , '2')->orderBydesc('id')->where('vendor_id',Auth::user()->id)->get();
    ...
    public function store_employee(Request $request){
        ...
        if ($validator->fails()){
            ...
            $employee = new User;
            $employee->vendor_id = Auth::user()->id;
