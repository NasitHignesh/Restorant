...
<div class="row justify-content-between align-items-center mb-3">
    <h5 class="text-uppercase"><?php echo e(trans('labels.subscription plan')); ?></h5>
    <div class="d-flex justify-content-end align-items-center">
        <a href="<?php echo e(URL::to('admin/plan/add')); ?>" class="btn btn-secondary px-2 d-flex">
...
<div class="row mb-7">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mt-3">
        <div class="card box-shadow border-0 h-100 text-dark plancard">
            <div class="card-body">
                <div class="mb-4">
                    <h1 class="mb-4 plan-price"><?php echo e(Helper::currency_formate($plandata->price, '1')); ?>
            ...
            <div class="card-footer bg-white border-top-0 my-2 text-center d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(URL::to('admin/plan/edit-' . $plandata->id)); ?>" class="btn btn-sm btn-info btn-size" tooltip="Edit">
                        <i class="fa-regular fa-pen-to-square "></i> </a>
                    <?php if(env('Environment') == 'sendbox'): ?>
                    <a onclick="myFunction()"> <i class="fa-regular fa-trash"></i></a>
                    <?php else: ?>
                    <a onclick="changestatus('<?php echo e($plandata->id); ?>','','<?php echo e(URL::to('admin/plan/delete')); ?>')" tooltip="Delete" class="btn btn-sm btn-danger btn-size">
                ...
                <a onclick="myFunction()" class="btn btn-success  btn-sm w-50 mt-2 rounded-5"><?php echo e(trans('labels.active')); ?></a>
                <?php elseif($plandata->is_available == 2): ?>
                <a onclick="myFunction()" class="btn btn-danger w-50 btn-sm mt-2 rounded-5"><?php echo e(trans('labels.inactive')); ?></a>
                <?php endif; ?>
                <?php else: ?>
                <?php if($plandata->is_available == 1): ?>
                <a onclick="changestatus('<?php echo e($plandata->id); ?>','2','<?php echo e(URL::to('admin/plan/status_change')); ?>')" class="btn btn-success  btn-sm w-50 mt-2 rounded-5"><?php echo e(trans('labels.active')); ?></a>
                <?php elseif($plandata->is_available == 2): ?>
                <a onclick="changestatus('<?php echo e($plandata->id); ?>','1','<?php echo e(URL::to('admin/plan/status_change')); ?>')" class="btn btn-danger w-50 btn-sm mt-2 rounded-5"><?php echo e(trans('labels.inactive')); ?></a>
                <?php endif; ?>
                <?php endif; ?>
                <?php else: ?>
                ...
                <small class="text-success d-block fw-500 text-start"><span><?php echo e(@$data['original']['plan_message']); ?></span></small>
                <?php else: ?>
                ...
                <small class="text-dark d-block fw-500 text-start"><?php echo e(@$data['original']['plan_message']); ?>
                    ...
                    : <span class="text-success"><?php echo e($data['original']['plan_date'] !="" ? Helper::date_format($data['original']['plan_date']):''); ?></span>
                </small>

                <?php else: ?>
                <small class="text-dark d-block fw-500 text-start"><?php echo e(@$data['original']['plan_message']); ?>

                    : <span class="text-danger"><?php echo e($data['original']['plan_date'] !="" ? Helper::date_format($data['original']['plan_date']) : ''); ?></span>
                </small>
                ...
                <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>" class="btn btn-sm d-block mt-2 bg-success text-white rounded-5 px-3"><?php echo e(trans('labels.subscribe')); ?></a>
                <?php endif; ?>
                <?php else: ?>
                <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                <small class="text-dark d-block fw-500 text-start"><?php echo e(@$data['original']['plan_message']); ?>
                ...
                <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>" class="btn btn-sm d-block bg-success text-white rounded-5 px-3"><?php echo e(trans('labels.subscribe')); ?></a>
                <?php else: ?>
                <small class="text-dark d-block fw-500 text-start"><?php echo e(@$data['original']['plan_message']); ?>
                ...
                <small class="text-dark fw-500 text-start">
                    <?php echo e(@$data['original']['plan_message']); ?>: <span class="text-success"><?php echo e($data['original']['plan_date'] !="" ? Helper::date_format($data['original']['plan_date']) : ''); ?></span>
                </small>
                <div class="d-flex justify-content-end w-100">
                    <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>" class="btn btn-sm bg-success text-white rounded-5 px-3 d-block">
                ...
                <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>" class="btn btn-sm bg-success text-white rounded-5 px-3 d-block"><?php echo e(trans('labels.subscribe')); ?></a>
                <?php endif; ?>
                <?php endif; ?>
                <?php else: ?>
                -
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php else: ?>
    <?php echo $__env->make('admin.theme.no_data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
<script src="<?php echo e(url(env('ASSETSPATHURL') . '/admin-assets/assets/js/custom/plan.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\vinay\restaurant_saas\resources\views/admin/plan/plan.blade.php ENDPATH**/ ?>