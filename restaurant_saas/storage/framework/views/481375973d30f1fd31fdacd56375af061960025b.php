...
unset($__errorArgs, $__bag); ?>
            ...
            <footer class="py-3 text-center bg-white fixed-bottom border-top">
                Copyrights @ 2021-22 &amp; <?php echo e(trans('labels.designed_developed_by')); ?> <a
                    href="https://infotechgravity.com/" target="_blank"><?php echo e(trans('labels.gravity_infotech')); ?></a>
            </footer>
        </div>
    </main>
...
</html><?php /**PATH E:\xampp\htdocs\vinay\restaurant_saas\resources\views/admin/theme/default.blade.php ENDPATH**/ ?>