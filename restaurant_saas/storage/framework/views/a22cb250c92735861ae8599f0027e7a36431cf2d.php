<header class="page-topbar">
    <div class="navbar-header">
        <button class="navbar-toggler d-lg-none d-md-block px-4" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarcollapse" aria-expanded="false" aria-controls="sidebarcollapse">
            <i class="fa-regular fa-bars fs-4"></i>
        </button>
        <div class="px-3 d-flex align-items-center">
            <?php if(session()->has('vendor_login')): ?>
            <a href="<?php echo e(URL::to('/admin/admin_back')); ?>" class="btn btn-primary btn-sm mx-1"><i class="fa-solid fa-backward"></i></a>
            <?php endif; ?>
            <?php if(Auth::user()->type == 5): ?>
            <a href="<?php echo e(URL::to('/' . Auth::user()->slug)); ?>" class="btn btn-outline-secondary btn-sm mx-1" target="_blank"><i class="fa-solid fa-link"></i>
            </a>
            <?php endif; ?>
...
</header><?php /**PATH E:\xampp\htdocs\vinay\restaurant_saas\resources\views/admin/theme/header.blade.php ENDPATH**/ ?>