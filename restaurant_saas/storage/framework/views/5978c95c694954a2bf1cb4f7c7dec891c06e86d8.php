<div class="row page-titles mx-0 mb-3">
    <div class="d-flex justify-content-between align-items-center">
        <ol class="breadcrumb mb-0">
            ...
            <?php endif; ?>
            <?php if(request()->is('admin/vendor*')): ?>
                <li class="breadcrumb-item"><a href="<?php echo e(URL::to('admin/vendor')); ?>"><?php echo e(trans('labels.vendor')); ?></a></li>
            <?php endif; ?>
            ...
            <?php if(request()->is('admin/plan*')): ?>
                <li class="breadcrumb-item"><a href="<?php echo e(URL::to('admin/plan')); ?>"><?php echo e(trans('labels.Subscription Plan')); ?></a></li>
            <?php endif; ?>
