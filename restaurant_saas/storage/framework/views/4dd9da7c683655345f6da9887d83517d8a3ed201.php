            ...
            <div class="card border-0">
                <div class="card-body">
                    <div class="form-validation">
                        <form action="<?php echo e(URL::to('admin/users/update-' . $getvendordata->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label class="col-form-label" for=""><?php echo e(trans('labels.name')); ?> <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="<?php echo e(trans('labels.name')); ?>" value="<?php echo e($getvendordata->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email" placeholder="<?php echo e(trans('labels.email')); ?>" value="<?php echo e($getvendordata->email); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="mobile" id="mobile" placeholder="<?php echo e(trans('labels.mobile')); ?>" value="<?php echo e($getvendordata->mobile); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label class="col-form-label" for=""><?php echo e(trans('labels.identity_image')); ?> (420 x 525) <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                                        <img src="<?php echo e(Helper::image_path($getvendordata->profile_image)); ?>" alt="" class="img-fluid rounded hw-50 mt-1">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="country" class="form-select" id="country" required>
                                        ...
                                        <option value="<?php echo e($country->id); ?>" <?php echo e($country->id == $getvendordata->country ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="city" class="form-select" id="city" required>
                                        ...
                                        <option value="<?php echo e(@$citys->id); ?>" <?php echo e($citys->id == $getvendordata->city ? 'selected' : ''); ?>><?php echo e(@$citys->city); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\vinay\restaurant_saas\resources\views/admin/vendor/edit.blade.php ENDPATH**/ ?>