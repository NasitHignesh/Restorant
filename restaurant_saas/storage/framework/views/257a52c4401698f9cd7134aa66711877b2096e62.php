...
<tbody>
    ...
    <?php $__currentLoopData = $topusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><img src="<?php echo e(Helper::image_path($user->profile_image)); ?>" class="rounded hw-50" alt=""></td>
...
</table><?php /**PATH E:\xampp\htdocs\vinay\restaurant_saas\resources\views/admin/dashboard/topuserstable.blade.php ENDPATH**/ ?>